...
const baseStyle = css`
  ...
  :hover{
      ...
      border: 1px solid ${state=>style.buttons[`${state.type}_inverse`].border};
  }
  :disabled{
      color: ${state=>style.buttons[`${state.type}_disabled`].text};
      background: ${state=>style.buttons[`${state.type}_disabled`].background};
      border: 1px solid ${state=>style.buttons[`${state.type}_disabled`].border};
  }
...
export const Btn = styled.button`${baseStyle}`
export const Link = styled(RouterLink)`${baseStyle}`
export const A = styled.a`${baseStyle}`
